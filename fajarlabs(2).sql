...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'Fajarlabs', 'admin@fajarlabs.com', '', '7566fajarlabs.jpg', 'admin', 'N', 'q173s8hs1jl04st35169ccl8o7'),
('user', 'ee11cbb19052e40b07aac0ca060c23ee', 'Paijo', 'paijo@yahoo.com', '', '85IMG_8395.JPG', 'user', 'N', '5bi6b98a7r02hvh15dsog2vfo2');
...
--
ALTER TABLE `album`
  MODIFY `id_album` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `berita`
  MODIFY `id_berita` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=655;
--
...
--
ALTER TABLE `kategori`
  MODIFY `id_kategori` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
...
--
ALTER TABLE `users_modul`
  MODIFY `id_umod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
--
