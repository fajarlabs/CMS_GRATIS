...
<html>
   ...
   <body class=special-page>
               ...
               <form id=login-form class="block-content form" action="aksi_login.php" method="post">
                  ...
                  <div class=block-actions>
                     <ul class=actions-left>
                        <li><a class="button red" id="reset-login" href="javascript:void(0);">BATALKAN</a></li>
                     </ul>
                     <ul class=actions-right>
                        <li><input type="submit" class="button" value="MASUK&nbsp;&nbsp;&nbsp;&nbsp;"/></li>
                     </ul>
                  </div>
               </form>
            </div>
      ...
      <script src="js/jquery.min.js"></script> <script>window.jQuery||document.write('<script src="js/libs/jquery-1.6.2.min.js"><\/script>');</script> <script defer src='js/zal.js'></script> 
    </body> 
</html>