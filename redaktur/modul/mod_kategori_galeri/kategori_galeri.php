...
$aksi="modul/mod_kategori_galeri/aksi_kategori_galeri.php";
switch($_GET[act]){
...
echo "  <div id='main-content'>
   ...
   <div class=grid_12> 
   <br/>
   <a href='?module=kategori_galeri&act=tambahkategorigaleri' class='button'>
   <span>Tambah Kategori Galeri +</span>
   </a></div>";
...
echo "
  ...
  echo "<tr class=gradeX> 
   ...
   <td>$r[jdl_album]</td>
   <td>kategori-$r[id_album]-$r[album_seo].html</td>
			 
  <td width=80>
   
  <a href=?module=kategori_galeri&act=editkategorigaleri&id=$r[id_album] title='Edit' class='with-tip'>
  <center><img src='img/edit.png'></a><a class='with-tip' href=javascript:confirmdelete('$aksi?module=kategori_galeri&act=hapus&id=$r[id_album]')>&nbsp;&nbsp;&nbsp;&nbsp;<img src='img/hapus.png' /></a></center>
...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  case "tambahkategorigaleri":
   ...
   <h1>MEMBUAT KATEGORI FOTO</h1>
   </div>
   <div class='block-content'>	
   
   <form method=POST action='$aksi?module=kategori_galeri&act=input' enctype='multipart/form-data'>
		  
   <p class=inline-small-label> 
   <label for=field4>Judul Kategori</label>
   ...
   <input type=file name='fupload' size=40>
      ...
      <li>
      <a class='button red' id=reset-validate-form href='?module=kategori_galeri'>Batal</a>
      </li> </ul>
  ...
  case "editkategorigaleri":
   ...
   <div class='block-content'>
    ...
    <form method=POST enctype='multipart/form-data' action=$aksi?module=kategori_galeri&act=update>
