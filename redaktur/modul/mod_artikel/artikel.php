...
switch($_GET[act]){
 ...
 echo "
   ...
   <div class=grid_12> 
   <br/>
   <a href='?module=artikel&act=tambahartikel' class='button'>
   ...
   <a href=?module=artikel&act=editartikel&id=$r[id_berita] title='Edit' class='with-tip'>
   <center><img src='img/edit.png'></a>
   
   <a href=javascript:confirmdelete('$aksi?module=artikel&act=hapus&id=$r[id_berita]&namafile=$r[gambar]') 
   ...
   echo "</table>";
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                <td>$r[judul]</td>
                <td>$tgl_posting</td>
		            <td><a href=?module=artikel&act=editberita&id=$r[id_berita]><img src='images/icn_edit.png' title='Edit'></a>  
 <a href=javascript:confirmdelete('$aksi?module=artikel&act=hapus&id=$r[id_berita]&namafile=$r[gambar]')>
 <img src='images/icn_trash.png' title='Hapus'></a>		        </tr>";
  ...
  <form method=POST action='$aksi?module=artikel&act=input' enctype='multipart/form-data'>
   ...
   <label for=field4>Judul Artikel</label>
   <input type=text name='judul' size=60>
   </p> 	  

   <p class=inline-small-label> 
   <label for=field4>Sub Judul Artikel</label>
  <input type=text name='sub_judul' size=60>
   ...
   echo "
   <p class=inline-small-label> 
   <label for=field4>Artikel Utama</label>
   ...
   <p class=inline-small-label> 
   <label for=field4>Isi Artikel</label>
   ...
   <li>
   <a class='button red' id=reset-validate-form href='?module=artikel'>Batal</a>
   </li> </ul>
