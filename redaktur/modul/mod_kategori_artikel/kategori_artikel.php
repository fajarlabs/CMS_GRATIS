...
$aksi="modul/mod_kategori_artikel/aksi_kategori_artikel.php";
switch($_GET[act]){
//update/////////////////////////////////////
...
echo "<div id=main-content> 
      ...
      <div class=grid_12> 
      <br/>
	  <a href='?module=kategori_artikel&act=tambahkategori' class='button'>
...
echo "<div class=grid_12> 
  ...
  <a href=?module=kategori_artikel&act=editkategori&id=$r[id_kategori] title='Edit' class='with-tip'>
  <center><img src='img/edit.png'></a>
   
  <a href=javascript:confirmdelete('$aksi?module=kategori_artikel&act=hapus&id=$r[id_kategori]') title='Hapus' class='with-tip'>
...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  echo "
   ...
   <form method=POST action='$aksi?module=kategori_artikel&act=input'>
   ...
   <input type=text name='nama_kategori' size=40>
      ...
      <li>
      <a class='button red' id=reset-validate-form href='?module=kategori_artikel'>Batal</a>
      </li> </ul>
  ...
  echo "
   ...
   <form method=POST action=$aksi?module=kategori_artikel&act=update>
